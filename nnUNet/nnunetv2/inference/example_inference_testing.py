if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, '2024-05-03-15.37/nnUNet_results/Dataset506_MDSC_Task06_Lung/nnUNetTrainer_ULS_500_HalfLR__nnUNetPlans__3d_fullres'),
        use_folds=('all'),
        checkpoint_name='checkpoint_final.pth',
    )

    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset500_RadboudumcBone/imagesTs/bone_00085_lesion_01_0000.nii.gz')])
    img2, props2 = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset500_RadboudumcBone/imagesTs/bone_00085_lesion_01_0000.nii.gz')])
    img3, props3 = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset500_RadboudumcBone/imagesTs/bone_00085_lesion_01_0000.nii.gz')])
    img4, props4 = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset500_RadboudumcBone/imagesTs/bone_00085_lesion_01_0000.nii.gz')])
